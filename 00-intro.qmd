...
Il s'agit d'un support de formation conçu pour initier des étudiants et jeunes chercheurs non familier de l'économétrie spatiales, avec un objet très concret. Ce document a été élaboré avec les priorités suivantes : 

- Familiariser avec la démarche scientifique : recherche bibliographique, revue d'articles économétriques ;
...
D'autres aspects ont volontairement été placés au second plan, en particulier la caractérisartion trop technique des sources et les subtilités associés aux modèles économétriques.
