...
## Méthode des doubles différences échelonnées simples

Pour réaliser un diff-in-diff, on va utiliser la méthode de différence de différences échelonnées (staggered matching) élaboréé par Callaway et Sant'Anna [-@callaway2021] et diffusée dans la librairie {did} [@did].
