...
On peut également réaliser une régression simple, qu'on présente selon le format courant pour la littérature en économie grâce au package {stargazer} .
...
Analyse la relation aux variables topologiques (altitude, indice de terrain accidenté) et de temps de trajer aux villes :
...
Temps de trajet aux villes significativement distinct entre les deux groupes. Attention, car cette variable pose un problème d'endogénéité.
...
Apparemment, le traitement reste sigificatif.